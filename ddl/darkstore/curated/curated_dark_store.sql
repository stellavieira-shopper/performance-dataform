CREATE OR REPLACE VIEW `shopper-performance-prod.operacao.curated_dark_store`
OPTIONS (description = 'Picking de pedidos de lojinha (dark store) por colaborador. Pedidos com código terminando em N.')
AS
